...
public:
  Camera()
    : position_(-5.0,3,40), front_dir_(0,0,-1), up_dir_(0,1,0), right_dir_(1,0,0), fovy_(45)
  {}
  ...
  glm::vec3 check_move_forward(float delta);
  glm::vec3 check_move_backward(float delta);
  glm::vec3 check_move_left(float delta);
  glm::vec3 check_move_right(float delta);
  glm::vec3 check_move_up(float delta);
  glm::vec3 check_move_down(float delta); 
